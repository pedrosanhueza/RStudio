...
The requirements were satisfied when:

* All expected counts were greater than 1.
* The average expected count is greater than 5.

Even though when R warns that the approximation may not be correct, the test could still appropriate to perform.
